...
exports.createClientProfile = async (req,res) => {
   ...
   const { email, gender, academiclevel, year} = req.body;
   const profilepicture = req.file.filename;
   let profilePicLink = `localhost:${process.env.APP_PORT}/resource/`+ profilepicture  
...
exports.updateProfile = (req, res) => {
   ...
   const newData = {firstname,lastname,gender,profilePicture,phone,email,academiclevel,year, institute: institute._id, changeProfile:false}
